    ...
    <html lang="de">
      <body style={{ fontFamily: "system-ui, sans-serif", margin: 0, display: "flex", alignItems: "center", justifyContent: "center", minHeight: "100vh", textAlign: "center", padding: "2rem" }}>
        <div>
          ...
          <Link href="/" style={{ background: "#000", color: "#fff", padding: "12px 28px", borderRadius: "12px", textDecoration: "none", fontSize: "13px", fontWeight: "bold", letterSpacing: "0.12em", textTransform: "uppercase" }}>ZUR STARTSEITE</Link>
        </div>
      </body>
    </html>
  );
