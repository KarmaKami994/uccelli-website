      ...
      <section className="py-20 lg:py-28 px-6 lg:px-10 bg-black text-white">
        <ScrollReveal className="max-w-[800px] mx-auto">
          ...
          <div className="space-y-5 text-[16px] text-neutral-300 leading-[1.8]">
            <p>Über die Sackgeldbörse erhalten Jugendliche die Möglichkeit, kleinere Arbeiten für Privatpersonen, Vereine oder Unternehmen zu übernehmen und dadurch ihr erstes eigenes Geld zu verdienen.</p>
            <p>Die Sackgeldbörse schafft einen direkten Bezug zwischen den Lerninhalten von LifeLab und der Lebensrealität der Jugendlichen. Wer eigenes Geld verdient, setzt sich automatisch mit Fragen auseinander wie: Was mache ich mit meinem Einkommen? Wie teile ich es sinnvoll ein?</p>
            <p>LifeLab verbindet Wissen, Erfahrung und persönliche Entwicklung zu einem ganzheitlichen Lernansatz. Unser Ziel ist es, Jugendliche dabei zu unterstützen, ihr Potenzial zu entfalten und sie mit den Kompetenzen auszustatten, die sie für ein selbstbestimmtes und erfolgreiches Leben benötigen.</p>
          </div>
