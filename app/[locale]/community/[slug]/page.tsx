...
import { CVGeneratorTool } from "@/components/community/CVGeneratorTool";
...
export default async function CommunityDetailPage({ params }: Params) {
  ...
  const isCVGenerator = slug === "cv-creator";
  ...
  return (
    <>
      ...
      <section className="py-16 lg:py-24 px-6 lg:px-10">
        <div className={isCVGenerator ? "max-w-[1400px] mx-auto" : "max-w-[800px] mx-auto"}>
